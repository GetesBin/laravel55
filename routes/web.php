...
*自管商城-我的积分
*/
Route::get('/Home/yourself','Home\HomeController@yourself');
/*
*自管商城-任务列表
*/
Route::get('/Home/tasklist','Home\HomeController@tasklist');
/*
*自管商城-接受任务
*/
Route::post('/Home/addtask','Home\HomeController@addtask');
